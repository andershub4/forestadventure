...
void StateMachine::OnInitStateData(const Configuration& configuration, const AnimationDB& animationDB)
{
    currentState_->OnInitStateData(configuration, animationDB);
}
