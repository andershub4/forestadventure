...
void StateMachine::OnInitStateData(const Configuration& configuration, const AnimationComponent& animation)
{
    currentState_->OnInitStateData(configuration, animation);
}
