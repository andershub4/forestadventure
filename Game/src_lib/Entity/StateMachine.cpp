...
void StateMachine::OnInitStateData(const ConfigurationData& configurationData, const AnimationComponent& animation)
{
    currentState_->OnInitStateData(configurationData, animation);
}
