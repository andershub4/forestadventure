...
{
    TileMapData::Object d1{2, "obj1", 12, 13, 2, 3, {{"speed", "4"}, {"money", "100"}}};
    auto d2 = d1;
    EXPECT_TRUE(d1 == d2);
...
{
    TileMapData::Object obj1{1, "obj1", 12, 13, 0, 0, {{"speed", "4"}, {"money", "100"}}};
    TileMapData::Object obj2{2, "obj2", 12, 13, 10, 10, {{"speed", "40"}, {"money", "0"}}};
...
TEST(TileMapDataTest, TestTileMapDataEqualToOperator)
{
    ...
    TileMapData::Object obj1{1, "type1", 12, 33, 4, 2, {{"AiMoveAlgo", "AStar"}}};
